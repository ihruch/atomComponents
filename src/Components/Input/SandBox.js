...
const Sandbox = () => (
  <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gridGap: '20px' }}>
    ...
    <Input id="text" type="text" value="Props value" />
    ...
    <Input id="range" value="50" onChange={() => {console.log('OnChange')}} type="range" />

    <h2><span>9. Input type checkbox (checked):</span></h2>
    <Input id="checkbox" checked onChange={() => {console.log('OnChange')}} type="checkbox" />
